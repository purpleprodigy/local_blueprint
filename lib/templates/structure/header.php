...
add_action( 'wp', 'beanschildstarter_set_up_header_structure' );
/**
 ...
 * @return void
 */
function beanschildstarter_set_up_header_structure() {
	// Remove Tagline
	...
	add_action( 'beans_header_before_markup', 'beanschildstarter_display_above_header_widget' );
	add_action( 'beans_header', 'beanschildstarter_display_header_widget' );
 ...
 * @return void
 */
function beanschildstarter_display_above_header_widget() {
 ...
 * @return void
 */
function beanschildstarter_display_header_widget() {
