...
if ( $css_dev_mode_enabled ) {
	add_action( 'wp_enqueue_scripts', 'beanschildstarter_enqueue_dev_styles' );
} else {
//Production CSS, autocompile
	add_action( 'beans_uikit_enqueue_scripts', 'beanschildstarter_enqueue_styles', 5 );
}
/**
...
function beanschildstarter_enqueue_dev_styles() {
...
function beanschildstarter_enqueue_styles() {
...
beans_add_smart_action( 'beans_uikit_enqueue_scripts', 'beanschildstarter_enqueue_uikit_assets', 5 );
/**
 ...
 * @return void
 */
function beanschildstarter_enqueue_uikit_assets() {
	beans_compiler_add_fragment( 'uikit', array(
...
// Google fonts
add_action( 'wp_enqueue_scripts', 'beanschildstarter_add_google_fonts' );
/**
 ...
 * @return void
 */
function beanschildstarter_add_google_fonts() {
