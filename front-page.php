...
$beanschildstarter_slideshow_enabled = (bool) get_option( 'beanschildstarter_slideshow', false );

if ( $beanschildstarter_slideshow_enabled ) {
	add_action( 'beans_fixed_wrap[_main]_prepend_markup', 'beanschildstarter_home_slider_section' );
	/**
	 ...
	 * @return void
	 */
	function beanschildstarter_home_slider_section() {
...
//Home Widgets
beans_add_smart_action( 'beans_fixed_wrap[_main]_append_markup', 'beanschildstarter_display_home_widgets' );
/**
 ...
 * @return void
 */
function beanschildstarter_display_home_widgets() {
